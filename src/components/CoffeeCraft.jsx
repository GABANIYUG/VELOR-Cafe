          ...
          <div className="craft-grid-container">
            ...
            <div className="craft-col-left">
              ...
              <p className="text-body" style={{ marginBottom: '32px', fontSize: '1.1rem' }}>
                Processed via <strong>{selectedBean.process}</strong>. Roasted in micro-batches to highlight fragrant floral aromas, rich body, and smooth velvet mouthfeel.
              </p>
