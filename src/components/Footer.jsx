  ...
  return (
    ...
    >
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 2 }}>
        ...
        <div className="footer-grid-container" style={{ marginBottom: '100px' }}>
        ...
        <div style={{ textAlign: 'center', margin: '40px 0 20px 0', opacity: 0.15, userSelect: 'none', overflow: 'hidden' }}>
          <span
